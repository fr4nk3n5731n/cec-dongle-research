...
| Manufacturer  | Name                                                                                            | Model                 | IC                 | Host Connection | Downstream Connections                                     | Supports CEC       | Picture                                         | Max Res & Hz                       |
|---------------|-------------------------------------------------------------------------------------------------|-----------------------|--------------------|-----------------|------------------------------------------------------------|--------------------|-------------------------------------------------|------------------------------------|
| Sabrent | 6-Port Docking Station for Steam Deck and USB C Devices | DS-SD6P | [TBD](#legend_tbd) | USB-C           | HDMI 2.0 (DP-Alt), 3x USB-A 3.0, 1x USB-C, USB-C PD IN 95W | [TBD](#legend_tbd) | ![sabrent_ds-sd6p](images/sabrent_ds-sd6p.jpeg) | [TBD](#legend_tbd) |
